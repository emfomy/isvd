...
function(GTEST_ADD_MPI_TESTS executable listprocs extra_args)
  if(NOT ARGN)
    message(FATAL_ERROR "Missing ARGN: Read the documentation for GTEST_ADD_TESTS")
  endif()
  if(ARGN STREQUAL "AUTO")
  ...
  foreach(source ${ARGN})
    ...
    foreach(hit ${found_tests})
      ...
      foreach(procs ${listprocs})
        add_test(NAME ${test_name}.${procs} COMMAND ${MPIEXEC} ${MPIEXEC_NUMPROC_FLAG} ${procs} ${CMAKE_COMMAND} -E env OMP_NUM_THREADS=${OMP_THRDS} ${executable} --gtest_filter=${test_name} ${extra_args})
      endforeach()
    endforeach()
  endforeach()
endfunction()
