...
function(GTEST_ADD_MPI_TESTS executable procs extra_args)
  if(NOT ARGN)
    message(FATAL_ERROR "Missing ARGN: Read the documentation for GTEST_ADD_TESTS")
  endif()
  if(ARGN STREQUAL "AUTO")
  ...
  foreach(source ${ARGN})
    ...
    foreach(hit ${found_tests})
      ...
      foreach(np ${procs})
        add_test(NAME ${test_name}.${np} COMMAND ${MPIEXEC} ${MPIEXEC_NUMPROC_FLAG} ${np} ${CMAKE_ENV} OMP_NUM_THREADS=4 ${executable} --gtest_filter=${test_name} ${extra_args})
      endforeach()
    endforeach()
  endforeach()
endfunction()
