...
function(DISP item var)
  ...
  elseif(var STREQUAL "OFF" OR var STREQUAL "")
...
message(STATUS "Set 'ISVD_USE_FORTRAN'          to enable Fortran API.")
...
disp("Use Fortran Compiler:           " "${CMAKE_Fortran_COMPILER}")

message(STATUS "")

disp("Use C       flags:              " "${CMAKE_C_FLAGS}")
disp("Use C++     flags:              " "${CMAKE_CXX_FLAGS}")
disp("Use Fortran flags:              " "${CMAKE_Fortran_FLAGS}")
