...
static void test( char dista, char ordera, const JobUV jobuv ) {
  ...
  switch ( jobuv ) {
    case GatherUV: {
      ...
      // Run stage
      isvd_@x@PostprocessSymmetric(param, NULL, 0, NULL, 0, dista_, ordera_, a, lda, qt, ldqt, s, ut_, ldut_, mpi_root);
    ...
    case BlockUV: {
      ...
      // Run stage
      isvd_@x@PostprocessSymmetric(param, NULL, 0, NULL, 0, dista_, ordera_, a, lda, qt, ldqt, s, ut, ldut, -1);
    ...
    default: {
      ...
      // Run stage
      isvd_@x@PostprocessSymmetric(param, NULL, 0, NULL, 0, dista_, ordera_, a, lda, qt, ldqt, s, NULL, 0, -2);
...
TEST(@XStr@SymmetricPostprocessing, BlockCol_ColMajor_GatherUV) {
  test('C', 'C', GatherUV);
}

TEST(@XStr@SymmetricPostprocessing, BlockCol_RowMajor_GatherUV) {
  test('C', 'R', GatherUV);
}

TEST(@XStr@SymmetricPostprocessing, BlockRow_ColMajor_GatherUV) {
  test('R', 'C', GatherUV);
}

TEST(@XStr@SymmetricPostprocessing, BlockRow_RowMajor_GatherUV) {
  test('R', 'R', GatherUV);
}

TEST(@XStr@SymmetricPostprocessing, BlockCol_ColMajor_BlockUV) {
  test('C', 'C', BlockUV);
}

TEST(@XStr@SymmetricPostprocessing, BlockCol_RowMajor_BlockUV) {
  test('C', 'R', BlockUV);
}

TEST(@XStr@SymmetricPostprocessing, BlockRow_ColMajor_BlockUV) {
  test('R', 'C', BlockUV);
}

TEST(@XStr@SymmetricPostprocessing, BlockRow_RowMajor_BlockUV) {
  test('R', 'R', BlockUV);
}


TEST(@XStr@SymmetricPostprocessing, BlockCol_ColMajor_NoUV) {
  test('C', 'C', NoUV);
}

TEST(@XStr@SymmetricPostprocessing, BlockCol_RowMajor_NoUV) {
  test('C', 'R', NoUV);
}

TEST(@XStr@SymmetricPostprocessing, BlockRow_ColMajor_NoUV) {
  test('R', 'C', NoUV);
}

TEST(@XStr@SymmetricPostprocessing, BlockRow_RowMajor_NoUV) {
  test('R', 'R', NoUV);
}
