...
TEST(@XStr@GaussianProjectionSketching, BlockCol_ColMajor) {
  test('C', 'C');
}

TEST(@XStr@GaussianProjectionSketching, BlockCol_RowMajor) {
  test('C', 'R');
}

TEST(@XStr@GaussianProjectionSketching, BlockRow_ColMajor) {
  test('R', 'C');
}

TEST(@XStr@GaussianProjectionSketching, BlockRow_RowMajor) {
  test('R', 'R');
}
