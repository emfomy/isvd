////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/// \file       lib/libisvd/gpu/stage/@x@_sketch_gpu.h
...
static void sketchBlockRow(
  ...
  cudaMemset(yst_gpu, 0, ldyst_gpu * mj * sizeof(@xtype_____@));
  char transa_ = (ordera == 'C') ? 'T' : 'N';
  isvd_int_t idx;
