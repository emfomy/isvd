...
static void sketchBlockCol(
  ...
  @xtype@ *domegat;
  magma_@x@malloc(&domegat, nj * Nl);
  isvd_int_t lddomegat = ldomegat;

  @xtype@ *dyst_;
  magma_@x@malloc(&dyst_, Pmb * Nl);
  ...
  magma_@x@setmatrix(Nl, nj, omegat, ldomegat, domegat, lddomegat);
  ...
  magma_@x@getmatrix(Nl, Pmb, dyst_, lddyst_, yst_, ldyst_);
